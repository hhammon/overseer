...
enum_flags(ProcessAccessFlags, u32) {
	ProcessAccessFlag_TERMINATE                  = 0x0001,
	ProcessAccessFlag_CREATE_THREAD              = 0x0002,
	ProcessAccessFlag_SET_SESSIONID              = 0x0004,
	ProcessAccessFlag_VM_OPERATION               = 0x0008,
	ProcessAccessFlag_VM_READ                    = 0x0010,
	ProcessAccessFlag_VM_WRITE                   = 0x0020,
	ProcessAccessFlag_DUP_HANDLE                 = 0x0040,
	ProcessAccessFlag_CREATE_PROCESS             = 0x0080,
	ProcessAccessFlag_SET_QUOTA                  = 0x0100,
	ProcessAccessFlag_SET_INFORMATION            = 0x0200,
	ProcessAccessFlag_QUERY_INFORMATION          = 0x0400,
	ProcessAccessFlag_SUSPEND_RESUME             = 0x0800,
	ProcessAccessFlag_QUERY_LIMITED_INFORMATION  = 0x1000,
	ProcessAccessFlag_SET_LIMITED_INFORMATION    = 0x2000,
};

/**
 * https://learn.microsoft.com/en-us/windows/win32/api/processthreadsapi/nf-processthreadsapi-openprocess
 */
DLLIMPORT Handle WINAPI OpenProcess(
	ProcessAccessFlags desired_access,
	b32                inherit_handle,
	u32                pid
);
 ...
 */
DLLIMPORT b32 WINAPI TerminateProcess(
	Handle process,
	u32    exit_code
);
